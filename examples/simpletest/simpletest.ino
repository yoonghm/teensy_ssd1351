...
#define dimension_x  128
#define dimension_y  128
...
auto display = ssd1351::SSD1351<Color, ssd1351::SingleBuffer, dimension_x, dimension_y>();

bool up = false;
int pos = dimension_x - 1;
...
void setup() {
  ...
  for (int i = 0; i < particles; i++) {
    x_pos[i] = random(0, dimension_x);
    y_pos[i] = random(0, dimension_y);
